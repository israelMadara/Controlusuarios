...
public class UsuariosController {
	...
	public Usuario eliminar(@PathVariable("id") int id) {
		return usuariosServiceImp.eliminar(id);
 ...
 public Usuario editar(@RequestBody Usuario u, @PathVariable("id") int id) {
	 u.setId(id);
	 return usuariosServiceImp.editar(u);
 }
	
	@GetMapping(path = {"/{id}"})
	public Usuario listarUsr(@PathVariable("id") int id  ) {
		return usuariosServiceImp.listarId(id);
	}
